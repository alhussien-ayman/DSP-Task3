...
function playAudio(type) {
    ...
    try {
        console.log(`▶️ Playing ${type} audio...`);
...
function pauseSignal() {
    if (playbackSource && isPlaying) {
        console.log(`⏸️ Pausing ${currentPlaybackBuffer} audio`);
...
window.generalMode = {
    ...
    initGeneral: function() {
        console.log("🔧 Initializing general mode components...");
        return init();
    },
    ...
    toggleInputSpectrogram: toggleInputSpectrogram,
    toggleOutputSpectrogram: toggleOutputSpectrogram,
    updateOutputVisualizations: updateOutputVisualizations,
    getInputVisualizations: getInputVisualizations,
    updateInputVisualizations: updateInputVisualizations,
    
    // Processing
    scheduleImmediateProcessing: scheduleImmediateProcessing,
    ...
    PROCESSING_DEBOUNCE_MS: PROCESSING_DEBOUNCE_MS,
    inputSignal: inputSignal,
    isAudioLoaded: isAudioLoaded,
    currentOutputScale: currentOutputScale,
...
console.log("✅ General mode exported to window.generalMode");
